...
const svg = `<svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="64" y="104" width="380" height="3" fill="#1D6BFF"/>
  ...
  <text x="60" y="398" font-family="Helvetica Neue, Helvetica, Arial" font-size="84" font-weight="700" letter-spacing="-2" fill="#1D6BFF">like an AI CEO.</text>
